...
def gerakqc():
    ...
    while True:
        ...
        ######## Gerak Serong
        if cX <= 280 and cX >= 0 and cY >= 280 and cY <= 480:
            print("Bergerak Maju Kiri")
            velocity(x, y, 0)
        elif cX <= 280 and cX >= 0 and cY <= 200 and cY >= 0:
            print("Bergerak Maju Kiri")
            velocity(x, y, 0)
        elif cX >= 360 and cX <= 640 and cY >= 280 and cY <= 480:
            print("Bergerak Mundur Kiri")
            velocity(x, y, 0)
        elif cX >= 360 and cX <= 640 and cY <= 200 and cY >= 0:
